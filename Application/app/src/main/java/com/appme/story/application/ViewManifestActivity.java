...
import com.appme.story.engine.app.utils.AXMLPrinter;
 ...
 */
public class ViewManifestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(getString(R.string.app_manifest) + ": " + applicationLabel);
    ...
    private void handleError() {
        Toast.makeText(this, R.string.app_handler_error, Toast.LENGTH_LONG).show();
        finish();
    }
