...
import com.appme.story.engine.widget.MonitorLayout;
...
public class AppMonitorFragment extends Fragment {
    ...
    public static AppMonitorFragment newInstance(String text) {
        AppMonitorFragment fragment = new AppMonitorFragment();
