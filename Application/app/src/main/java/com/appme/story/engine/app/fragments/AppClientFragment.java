...
import com.appme.story.engine.widget.ClientLayout;
import com.appme.story.settings.theme.ThemePreference;

public class AppClientFragment extends Fragment {

    private static final String EXTRA_TEXT = "text";
    private AppCompatActivity mActivity;
    private Context mContext;
    private Toolbar mToolbar;
    private ClientLayout mClient;
    
    public static AppClientFragment newInstance(String text) {
        AppClientFragment fragment = new AppClientFragment();
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mClient = (ClientLayout)view.findViewById(R.id.app_client);
    }
