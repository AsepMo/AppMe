...
public class AppInfoAdapter extends BaseAdapter implements SectionIndexer, Filterable {
    ...
    public AppInfoAdapter(Activity activity) {
        ...
        mColorBackground = ContextCompat.getColor(mActivity, R.color.app_info_background);
        mColorBackgroundPrimary = ContextCompat.getColor(mActivity, R.color.app_list_background_primary);
        mColorBackgroundSecondary = ContextCompat.getColor(mActivity, R.color.app_list_background_secondary);
        mColorStopped = ContextCompat.getColor(mActivity, R.color.app_color_stopped);
        mColorOrange = ContextCompat.getColor(mActivity, R.color.app_color_orange);
        mColorPrimary = ContextCompat.getColor(mActivity, R.color.app_textColorPrimary);
        mColorSecondary = ContextCompat.getColor(mActivity, R.color.app_textColorSecondary);
        mColorRed = ContextCompat.getColor(mActivity, R.color.app_color_red);
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        try {
            ...
            holder.issuer.setTextColor(i % 2 == 0 ? mColorSecondary : mColorPrimary);
            holder.sha.setText((String)item.sha.getSecond());
            holder.sha.setTextColor(i % 2 == 0 ? mColorSecondary : mColorPrimary);
        ...
        if (Build.VERSION.SDK_INT >= 26)  {
            ...
            holder.size.setTextColor(i % 2 == 0 ? mColorSecondary : mColorPrimary);
        }
        return view;
    }
