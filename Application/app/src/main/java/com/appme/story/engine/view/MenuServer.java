...
public class MenuServer extends RelativeLayout {
    ...
    public void addMessage(String title) {
        ...
        intent.setAction(ApplicationMonitor.ACTION_MESSAGE_SERVER);
    ...
    public void addCamera(String title) {
        ...
        Intent intent = new Intent(mContext, ApplicationMonitor.class);
        intent.setAction(ApplicationMonitor.ACTION_CAMERA_SERVER);
        emailElement.setIntent(intent);
    ...
    public void addWebServer(String title) {
        ...
        Intent intent = new Intent(mContext, ApplicationMonitor.class);
        intent.setAction(ApplicationMonitor.ACTION_WEB_SERVER);
        emailElement.setIntent(intent);
    ...
    public void addRemoteControl(String title) {
        ...
        Intent intent = new Intent(mContext, ApplicationMonitor.class);
        intent.setAction(ApplicationMonitor.ACTION_RC_SERVER);
        emailElement.setIntent(intent);
    ...
    public void addLog(String title) {
        ...
        Intent intent = new Intent(mContext, ApplicationMonitor.class);
        intent.setAction(ApplicationMonitor.ACTION_LOGCAT_SERVER);
        emailElement.setIntent(intent);
