...
import com.appme.story.engine.view.Element;
import com.appme.story.engine.view.MenuClient;
...
public class ClientLayout extends RelativeLayout {
    ...
    private MenuClient mMenuServer;
    ...
    protected void onFinishInflate() {
        ...
        mFrameLayout = mInflater.inflate(R.layout.layout_client, this, false);
        addView(mFrameLayout); 

        //mStorageMonitor = (StorageMonitor)mFrameLayout.findViewById(R.id.storage_monitor);
        mMenuServer = (MenuClient)mFrameLayout.findViewById(R.id.menu_client);
        ...
        mMenuServer.addItem(new Element().setTitle("Menu Client :"));
        ...
        mMenuServer.addWebServer("Web Client");
    ...
    public Element getCopyRightsElement() {
        ...
        final String copyrights = String.format(mContext.getString(R.string.app_copy_right), Calendar.getInstance().get(Calendar.YEAR));
