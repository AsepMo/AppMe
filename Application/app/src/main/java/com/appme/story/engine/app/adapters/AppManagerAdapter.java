...
public class AppManagerAdapter extends BaseAdapter {
    ...
    public List<AppManagerItem> mlistAppInfo;
    private LayoutInflater infater = null;
    private Context mContext;
    public static List<Integer> clearIds;
    private Drawable icon;
    public AppManagerAdapter(Context context, List<AppManagerItem> apps) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final AppManagerItem rowItem = (AppManagerItem) getItem(position);
        if (rowItem != null) {
        ...
        icon = AppCompatResources.getDrawable(mContext, R.drawable.ic_menu_overflow);     
        ...
        holder.btnMenu.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    final AppManagerItem menu_item = (AppManagerItem) getItem(position);
                            ...
                            public boolean onMenuItemClick(MenuItem item) {
                                ...
                                if (i == R.id.menu_open) {
                                    ...
                                    if (i1 != null)
                                        ...
                                        Toast.makeText(mContext, mContext. getString(R.string.app_manager_not_allowed), Toast.LENGTH_LONG).show();                                
                                    return true;
                                } else if (i == R.id.menu_backup) {
                                    new AlertDialog.Builder(mContext, R.style.Theme_AppCompat_DayNight_Dialog_Alert)
                                        .setTitle(mContext.getString(R.string.action_manager_backup) + " Instalasi Aplikasi")
                                        .setMessage("Instalan " + menu_item.getAppName() + " Akan Di Backup")
                                        .setPositiveButton(mContext.getString(R.string.action_manager_backup), new DialogInterface.OnClickListener(){
                                            @Override
                                            public void onClick(DialogInterface dialog, int which) {
                                                boolean backup = AppUtil.backupApk(mContext, menu_item.getSourceDir());
                                                if (backup) {
                                    ...
                                    AppUtil.shareFiles(act, arrayList2, R.color.colorAccent);                           
                                    return true;
