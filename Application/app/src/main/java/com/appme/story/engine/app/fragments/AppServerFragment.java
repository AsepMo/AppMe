...
import com.appme.story.engine.widget.ServerLayout;
...
public class AppServerFragment extends Fragment {
    ...
    private ServerLayout mServer;
    
    public static AppServerFragment newInstance(String text) {
        AppServerFragment fragment = new AppServerFragment();
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mServer = (ServerLayout)view.findViewById(R.id.app_server);
    }
