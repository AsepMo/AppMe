...
import com.github.template.engine.graphics.CircularEncoderBuffer;

import java.io.IOException;
import java.nio.ByteBuffer;

import com.github.template.R;
import com.github.template.engine.app.utils.CodecUtils;
...
public class VideoWindow extends LinearLayout implements SurfaceHolder.Callback{
    ...
    public void doDecoderThingie() {
        ...
        if (ApplicationActivity.DEBUG) Log.d(TAG, "Decoder Configured");
        ...
        while (!outputDone) {
            ...
            if (decoderConfigured) {
                ...
                if (decoderStatus == MediaCodec.INFO_TRY_AGAIN_LATER) {
                    if (ApplicationActivity.DEBUG) Log.d(TAG, "no output from decoder available");
                } else if (decoderStatus == MediaCodec.INFO_OUTPUT_BUFFERS_CHANGED) {
                    if (ApplicationActivity.DEBUG) Log.d(TAG, "decoder output buffers changed");
