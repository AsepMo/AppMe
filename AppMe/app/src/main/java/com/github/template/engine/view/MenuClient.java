...
public class MenuClient extends RelativeLayout {
    ...
    public void addMessage(String title) {
        ...
        intent.setAction(MonitorActivity.ACTION_MESSAGE_CLIENT);
    ...
    public void addScreen(String title) {
        ...
        Intent intent = new Intent(mContext, MonitorActivity.class);
        intent.setAction(MonitorActivity.ACTION_SCREEN_CLIENT);
        emailElement.setIntent(intent);
    ...
    public void addCamera(String title) {
        ...
        Intent intent = new Intent(mContext, MonitorActivity.class);
        intent.setAction(MonitorActivity.ACTION_CAMERA_CLIENT);
        emailElement.setIntent(intent);
    ...
    public void addFileTransfer(String title) {
        ...
        Intent intent = new Intent(mContext, MonitorActivity.class);
        intent.setAction(MonitorActivity.ACTION_FILE_CLIENT);
        emailElement.setIntent(intent);
    ...
    public void addWebServer(String title) {
        ...
        Intent intent = new Intent(mContext, MonitorActivity.class);
        intent.setAction(MonitorActivity.ACTION_WEB_CLIENT);
        emailElement.setIntent(intent);
    ...
    public void addRemoteControl(String title) {
        ...
        Intent intent = new Intent(mContext, MonitorActivity.class);
        intent.setAction(MonitorActivity.ACTION_RC_CLIENT);
        emailElement.setIntent(intent);
    ...
    public void addLog(String title) {
        ...
        Intent intent = new Intent(mContext, MonitorActivity.class);
        intent.setAction(MonitorActivity.ACTION_LOGCAT_CLIENT);
        emailElement.setIntent(intent);
