...
import com.github.template.engine.view.DetailOverflowMenu;
...
public class AppInfoDetailFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mColorBackground = getResources().getColor(R.color.apps_list_background);
        mColorBackgroundPrimary = getResources().getColor(R.color.apps_list_background_primary);
        mColorBackgroundSecondary = getResources().getColor(R.color.apps_list_background_secondary);
        mTextColorPrimary = getResources().getColor(R.color.apps_textColorPrimary);
        mTextColorSecondary = getResources().getColor(R.color.apps_textColorSecondary);
        
        mOrange1 = getResources().getColor(R.color.apps_orange);
    ...
    private class Adapter extends BaseExpandableListAdapter {
        ...
        private View getActivityView(ViewGroup viewGroup, View convertView, int index) {
            ...
            //LaunchMode
            viewHolder.textView4.setText(getString(R.string.app_launch_mode) + ": " + Utils.getLaunchMode(activityInfo.launchMode) +" | "+getString(R.string.app_orientation) + ": " + Utils.getOrientationString(activityInfo.screenOrientation));
            ...
            viewHolder.textView6.setText(getString(R.string.app_softInput) + ": " + Utils.getSoftInputString(activityInfo.softInputMode) + " | " +(activityInfo.permission==null ? getString(R.string.app_require_no_permission):activityInfo.permission));
        ...
        private View getReceiverView(ViewGroup viewGroup, View convertView, int index) {
            ...
            //SoftInput //(Build.VERSION.SDK_INT >= 21 ? activityInfo.persistableMode :"")+
            viewHolder.textView6.setText(getString(R.string.app_softInput) + ": " + Utils.getSoftInputString(activityInfo.softInputMode));
            viewHolder.textView6.setTextColor(index % 2 == 0 ? mTextColorSecondary : mTextColorPrimary);
        ...
        private View getPermissionsView(ViewGroup viewGroup, View convertView, int index) {
            ...
            //Protection level
            viewHolder.textView5.setText(getString(R.string.app_protection_level) + ": " + Utils.getProtectionLevelString(permissionInfo.protectionLevel));
            viewHolder.textView5.setTextColor(index % 2 == 0 ? mTextColorSecondary : mTextColorPrimary);
        ...
        private View getFeaturesView(ViewGroup viewGroup, View convertView, int index) {
            ...
            //Falgs
            viewHolder.textView2.setText(getString(R.string.app_flags) + ": " + Utils.getFeatureFlagsString(featureInfo.flags)
                                         +(Build.VERSION.SDK_INT >= 24 && featureInfo.version !=0 ? " | minV%:"+featureInfo.version : ""));
            viewHolder.textView2.setTextColor(index % 2 == 0 ? mTextColorSecondary : mTextColorPrimary);
            
            //GLES ver
            viewHolder.textView3.setText(getString(R.string.app_gles_ver) + ": " + (bFi && !featureInfo.name.equals("_MAJOR") ? "_":Utils.getOpenGL(featureInfo.reqGlEsVersion)));
            viewHolder.textView3.setTextColor(index % 2 == 0 ? mTextColorSecondary : mTextColorPrimary);
        ...
        private View getConfigurationView(ViewGroup viewGroup, View convertView, int index) {
            ...
            //GLES ver
            viewHolder.textView1.setText(getString(R.string.app_gles_ver) + ": " + Utils.getOpenGL(configurationInfo.reqGlEsVersion));
            viewHolder.textView1.setTextColor(index % 2 == 0 ? mTextColorSecondary : mTextColorPrimary);
