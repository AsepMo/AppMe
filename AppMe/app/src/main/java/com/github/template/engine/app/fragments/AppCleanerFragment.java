...
import com.github.template.application.SettingsActivity;
import com.github.template.engine.app.models.AppCleanerItem;
import com.github.template.engine.app.adapters.AppCleanerAdapter;
import com.github.template.engine.app.utils.Utils;
import com.github.template.engine.widget.DividerDecoration;
import com.github.template.engine.widget.RecyclerView;
import com.github.template.service.CleanerService;

import java.util.List;

public class AppCleanerFragment extends Fragment implements CleanerService.OnActionListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getActivity().getApplication().bindService(new Intent(getActivity(), CleanerService.class), mServiceConnection, Context.BIND_AUTO_CREATE);
    }
