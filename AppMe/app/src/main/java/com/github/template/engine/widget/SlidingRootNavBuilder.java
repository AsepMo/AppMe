...
import com.github.template.engine.widget.callback.DragListener;
import com.github.template.engine.widget.callback.DragStateListener;
import com.github.template.engine.widget.transform.CompositeTransformation;
import com.github.template.engine.widget.transform.ElevationTransformation;
import com.github.template.engine.widget.transform.RootTransformation;
import com.github.template.engine.widget.transform.ScaleTransformation;
import com.github.template.engine.widget.transform.YTranslationTransformation;
import com.github.template.engine.widget.util.ActionBarToggleAdapter;
import com.github.template.engine.widget.util.DrawerListenerAdapter;
import com.github.template.engine.widget.util.HiddenMenuClickConsumer;
...
public class SlidingRootNavBuilder {
    ...
    private ViewGroup getContentView() {
        ...
        if (contentView.getChildCount() != 1) {
            throw new IllegalStateException(activity.getString(R.string.app_ex_bad_content_view));
        }
        return contentView;
    }
    ...
    private View getMenuViewFor(SlidingRootNavLayout parent) {
        if (menuView == null) {
            if (menuLayoutRes == 0) {
                throw new IllegalStateException(activity.getString(R.string.app_ex_no_menu_view));
            }
