...
import com.github.template.engine.app.listeners.OnNetworkConnectionChangeListener;
import com.github.template.engine.app.listeners.StopReceiveDisconnectedListener;
import com.github.template.engine.app.listeners.SubscribeNetworkObserverChange;
import com.github.template.receiver.NetworkBroadcastReceiver;
import com.github.template.receiver.NetworkBroadcastReceiver.NetworkState;
...
public class CheckNetworkConnectionHelper extends SubscribeNetworkObserverChange implements LifecycleObserver {
    ...
    public void registerNetworkChangeListener(OnNetworkConnectionChangeListener listener) {
        ...
        if (mNetworkBroadcastReceiver == null) {
            mNetworkBroadcastReceiver = new NetworkBroadcastReceiver(new NetworkBroadcastReceiver.NetworkListener(){
                    @Override
