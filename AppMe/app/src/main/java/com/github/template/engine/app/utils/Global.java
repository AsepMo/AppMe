package com.github.template.engine.app.utils;
...
import com.github.template.receiver.RemoteLogger;
...
public class Global {
    ...
    public static void startOpenIntent(Context context, String fileLocation) {
        try {
            ...
            Toast.makeText(context,
                           context.getResources().getString(R.string.open_file_activity_not_found),
                           Toast.LENGTH_LONG).show();
        } catch (IllegalArgumentException e) {
            e.printStackTrace();
            Toast.makeText(context,
                           context.getResources().getString(R.string.unable_to_find_file) + fileLocation,
                           Toast.LENGTH_LONG).show();
        }
    }
    ...
    public static void startFileShareIntent(Context context, String fileLocation) {
        try {
            ...
            Uri fileUri = FileProvider.getUriForFile(context, "com.sharing.screen.fileprovider",
            ...
            e.printStackTrace();
            Toast.makeText(context,
                           context.getResources().getString(R.string.share_file_activity_not_found),
                           Toast.LENGTH_LONG).show();
        } catch (IllegalArgumentException e) {
            e.printStackTrace();
            Toast.makeText(context,
    ...
    public static void deleteFile(Context context, String fileLocation) {
        ...
        if (result) {
            Toast.makeText(context, R.string.deleted_file_successfully,
    ...
    public static void loadJSONToMap(Context c, Map<Integer, Pair<String, String>> map, JSONObject jsonObject) throws JSONException{
        ...
        RemoteLogger.sendBroadcast(c, "Parsed JSON and class names added to map.");
    }
