...
import com.github.template.engine.graphics.ImageTransmogrifier;
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (intent.getAction() == null) {
            ...
            if (resultData != null) {
                ...
                Intent ui = new Intent(this, MonitorActivity.class);
                ui.setAction(MonitorActivity.ACTION_MONITOR_SCREEN);
