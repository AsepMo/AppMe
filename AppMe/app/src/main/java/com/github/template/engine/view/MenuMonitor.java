...
public class MenuMonitor extends RelativeLayout {
    ...
    public void addReceiver(String title) {
        ...
        Intent intent = new Intent(mContext, MonitorActivity.class);
        intent.setAction(MonitorActivity.ACTION_MONITOR_RECEIVER);
        emailElement.setIntent(intent);
    ...
    public void addPackageReceiver(String title) {
        Element emailElement = new Element();
        emailElement.setTitle(title);
        emailElement.setIconDrawable(R.drawable.ic_android);
        emailElement.setIconTint(R.color.textColorPrimary);

        Intent intent = new Intent(mContext, MonitorActivity.class);
        intent.setAction(MonitorActivity.ACTION_MONITOR_PACKAGE_RECEIVER);
        emailElement.setIntent(intent);
    ...
    public void addSdcard(String title) {
        Element emailElement = new Element();
        emailElement.setTitle(title);
        emailElement.setIconDrawable(R.drawable.ic_sdcard);
        emailElement.setIconTint(R.color.textColorPrimary);
    ...
    public void addMemory(String title) {
        Element emailElement = new Element();
        emailElement.setTitle(title);
        emailElement.setIconDrawable(R.drawable.ic_memory);
        emailElement.setIconTint(R.color.textColorPrimary);

        Intent intent = new Intent(mContext, MonitorActivity.class);
        intent.setAction(MonitorActivity.ACTION_MONITOR_MEMORY);
        emailElement.setIntent(intent);
    ...
    public void addScreen(String title) {
        ...
        Intent intent = new Intent(mContext, MonitorActivity.class);
        intent.setAction(MonitorActivity.ACTION_MONITOR_SCREEN);
        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        intent.putExtra(MonitorActivity.EXTRA_TYPE, "SCREEN_SHOT");
        intent.putExtra(MonitorActivity.EXTRA_PATH, file.getAbsolutePath());
        emailElement.setIntent(intent);
    ...
    public void addLog(String title) {
        ...
        Intent intent = new Intent(mContext, MonitorActivity.class);
        intent.setAction(MonitorActivity.ACTION_MONITOR_LOGGER);
        emailElement.setIntent(intent);
