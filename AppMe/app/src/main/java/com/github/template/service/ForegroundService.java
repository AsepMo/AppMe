...
import com.github.template.engine.app.tasks.ForegroundTaskHandler;
...
import com.github.template.engine.graphics.ImageGenerator;
...
public class ForegroundService extends Service {
    ...
    private Notification getNotificationStart() {
        final Intent mainActivityIntent = new Intent(this, MonitorActivity.class);
